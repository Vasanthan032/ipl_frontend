...
def get_top_10_batsmen(self,year):
    ...
    file_name = self.graph.create_barplot(df=df,x_label='Batsman Name', y_label='Runs Scored',
                          x_col="batsmen_name",y_col='runs_scored')
    return file_name 
...
def get_top_six_hitters(self,year):
    ...
    file_name = self.graph.create_barplot(df=df,x_label='Batsman Name', y_label='Sixes',
                          x_col="batsmen_name",y_col='sixes')
    return file_name 
...
def get_top_four_hitters(self,year):
    ...
    file_name = self.graph.create_barplot(df=df,x_label='Batsman Name', y_label='Fours',
                          x_col="batsmen_name",y_col='fours')
    return file_name
